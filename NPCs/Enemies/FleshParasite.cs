...
{
    public class FleshParasite : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Flesh Parasite");
        ...
        {
            int dust = Dust.NewDust(npc.position, npc.width, npc.height, DustID.Blood, 0f, 0f, 0, default);
